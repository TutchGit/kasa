...
root.render(
  <React.StrictMode>
    <Router>
      <Routes>
        <Route exact path='/' element={<React.Fragment><Header /><App /><Footer /></React.Fragment>}></Route>
        ...
        <Route path="A-Propos" element={<React.Fragment><Header /><Propos /><Footer /></React.Fragment>}></Route>
